            ...
            <ul class="list-group list-group-flush">
                <li
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                                <img src="{{ url("admins/assets/img/avatars/1.png")}}" alt
                ...
                <li
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                                <img src="{{ url("admins/assets/img/avatars/2.png")}}"" alt
                                    class="h-auto rounded-circle" />
                            </div>
                        </div>
                        <div class="flex-grow-1">
                ...
                <li
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                                <img src="{{ url("admins/assets/img/avatars/9.png")}}" alt
                                    class="h-auto rounded-circle" />
                            </div>
                        </div>
                        <div class="flex-grow-1">
                ...
                <li
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                                <img src="{{ url("admins/assets/img/avatars/5.png")}}" alt
                                    class="h-auto rounded-circle" />
                            </div>
                        </div>
                        <div class="flex-grow-1">
                ...
                <li
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                                <img src="{{ url("admins/assets/img/avatars/6.png")}}" alt
                                    class="h-auto rounded-circle" />
                            </div>
                        </div>
                        <div class="flex-grow-1">
      ...
      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
        <div class="avatar avatar-online">
         @if(Auth::user()->user_type == 2)
            ...
            @endphp
         <img src="{{ url('public/logos/'.$company->logo)}}" class="h-auto rounded-circle" />
          
         @else
            <img src="{{ url("admins/assets/img/avatars/1.png")}}" alt class="h-auto rounded-circle" />
         @endif
